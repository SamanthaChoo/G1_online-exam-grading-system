...
from app.models import User, Course, Exam, CourseLecturer, ExamAttempt, EssayAnswer, MCQResult, Student
    ...
    if course_id:
        ...
        for exam in exams:
            ...
            for attempt in attempts:
                ...
                essay_total = sum(
                    (ans.marks_awarded or 0) for ans in essay_answers
                ) if essay_answers else None
